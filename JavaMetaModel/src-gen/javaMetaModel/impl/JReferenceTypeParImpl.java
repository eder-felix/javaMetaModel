...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JReference Type Par</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link javaMetaModel.impl.JReferenceTypeParImpl#getRefType <em>Ref Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JReferenceTypeParImpl extends JParameterImpl implements JReferenceTypePar {
	/**
	 ...
	 * @generated
	 */
	protected JReferenceTypeParImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JavaMetaModelPackage.Literals.JREFERENCE_TYPE_PAR;
	}
	...
	public void setRefType(String newRefType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMetaModelPackage.JREFERENCE_TYPE_PAR__REF_TYPE,
					oldRefType, refType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JavaMetaModelPackage.JREFERENCE_TYPE_PAR__REF_TYPE:
			return getRefType();
		}
