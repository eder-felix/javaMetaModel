 ...
 * </p>
 * <ul>
 *   <li>{@link javaMetaModel.impl.JElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JElementImpl extends MinimalEObjectImpl.Container implements JElement {
	...
	protected EClass eStaticClass() {
		return JavaMetaModelPackage.Literals.JELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaMetaModelPackage.JELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JavaMetaModelPackage.JELEMENT__NAME:
			return getName();
		}
