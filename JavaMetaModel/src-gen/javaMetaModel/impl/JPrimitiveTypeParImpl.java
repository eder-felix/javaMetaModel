...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JPrimitive Type Par</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link javaMetaModel.impl.JPrimitiveTypeParImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JPrimitiveTypeParImpl extends JParameterImpl implements JPrimitiveTypePar {
	/**
	 ...
	 * @generated
	 */
	protected JPrimitiveTypeParImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JavaMetaModelPackage.Literals.JPRIMITIVE_TYPE_PAR;
	}
	...
	public void setPrimitiveType(PrimitiveType newPrimitiveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JavaMetaModelPackage.JPRIMITIVE_TYPE_PAR__PRIMITIVE_TYPE, oldPrimitiveType, primitiveType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JavaMetaModelPackage.JPRIMITIVE_TYPE_PAR__PRIMITIVE_TYPE:
